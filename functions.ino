...
//          }
    ...
    if (str == 63) { // знак ?
      Serial.print("\n\nстатистика сенсора: "); Serial.print(sensorStat);Serial.print(", длина стат. массива: "); Serial.print(arrStatLengthEff);
      Serial.print("\nстатистика из EEPROM: ");Serial.print(EEPROM.get(0, sensorStat));
      Serial.print("\nsensorThres: "); Serial.print(sensorThres);Serial.print(", sensorOverThres: "); Serial.print(sensorOverThres);Serial.print(", sensorThresHysteresys: "); Serial.println(sensorThresHysteresys);
      Serial.print("\n");
      delay(2000);
    }
...
//Serial.print("sizeof(arrStat) = ");Serial.println(sizeof(arrStat));
    ...
    digitalWrite(yellow, LOW);
    Serial.print("\nMODE: reset & auto");
    Serial.print("\tстатистику в EEPROM: "); Serial.println(EEPROM.get(0, sensorStat));
    Serial.println();
  }
}
...
int smoothStart() {
  ...
  Serial.print(".");delay(300);
  Serial.print(".");delay(300);
  Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);Serial.print(".");delay(100);
